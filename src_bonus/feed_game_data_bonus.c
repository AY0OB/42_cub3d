...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   feed_game_data_bonus.c                             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: amairia <marvin@42.fr>                     +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/11/15 03:35:04 by amairia           #+#    #+#             */
/*   Updated: 2025/12/02 00:10:01 by amairia          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../include/cub3d_bonus.h"

static void	set_color_and_size(t_game *game, t_data *data)
{
	game->floor_color
		= data->fc[0][0] << 16 | data->fc[0][1] << 8 | data->fc[0][2];
	game->ceiling_color
		= data->fc[1][0] << 16 | data->fc[1][1] << 8 | data->fc[1][2];
	game->map_width = data->xy[0];
	game->map_height = data->xy[1];
}
